...
To make it easier... as you do the mental calculations in the water you either freeze when you realise you
...
object kyu8_SharkPontoon extends App {
  def shark(
    ...
    val youPontoonTime = pontoon_distance/you_speed
    val sharkPontoonTime = {
      if (dolphin == true) shark_distance/(shark_speed/2)
      else shark_distance/shark_speed
    }

    if (sharkPontoonTime <= youPontoonTime) "Shark Bait!"
    else "Alive!"
